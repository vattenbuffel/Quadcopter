...
#define CONTROLLER_PID_ORIENTATION_D 0.05
// CONTROLLER_PID_HEIGHT_I can't be 0
#define CONTROLLER_PID_HEIGHT_P 0
#define CONTROLLER_PID_HEIGHT_I 50
...
#define CONTROLLER_HEIGHT_PID_START_THROTTLE_VAL 400
#define CONTROLLER_HEIGHT_PID_START_THROTTLE (CONTROLLER_HEIGHT_PID_START_THROTTLE_VAL/CONTROLLER_PID_HEIGHT_I)
