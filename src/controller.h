...
#define CONTROLLER_PID_ORIENTATION_P 500
...
#define CONTROLLER_HEIGHT_PID_START_THROTTLE_VAL 600
#define CONTROLLER_HEIGHT_PID_START_I (CONTROLLER_HEIGHT_PID_START_THROTTLE_VAL/CONTROLLER_PID_HEIGHT_I)

#define CONTROLLER_MAX_X degToRad(20)
#define CONTROLLER_MAX_Y degToRad(20)
